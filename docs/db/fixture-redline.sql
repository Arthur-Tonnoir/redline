...
insert into redline.formation set id=6,nom_formation='HTML/CSS',contenu="text",prix_formation=5500;
insert into redline.formation set id=7,nom_formation='Initition aux langages C#',contenu="text",prix_formation=1500;
insert into redline.formation set id=8,nom_formation='principes de bases',contenu="text",prix_formation=3600;
insert into redline.formation set id=9,nom_formation='VBA',contenu="text",prix_formation=1300;
insert into redline.formation set id=10,nom_formation='.NET',contenu="text",prix_formation=1200;
insert into redline.formation set id=11,nom_formation='J#',contenu="text",prix_formation=5500;
insert into redline.formation set id=12,nom_formation='C',contenu="text",prix_formation=1500;
insert into redline.formation set id=13,nom_formation='C++',contenu="text",prix_formation=3600;
insert into redline.formation set id=14,nom_formation='Développement sous Linux',contenu="text",prix_formation=1300;
insert into redline.formation set id=15,nom_formation='Introduction aux POO',contenu="text",prix_formation=1200;
insert into redline.formation set id=16,nom_formation='Les classes en C++',contenu="text",prix_formation=5500;
insert into redline.formation set id=17,nom_formation='Solution pour des applications réparties',contenu="text",prix_formation=1500;
insert into redline.formation set id=18,nom_formation='La valiadation de structure (DTD, XML-Schema)',contenu="text",prix_formation=3600;
insert into redline.formation set id=19,nom_formation='Les transformations (XSL, XSLT, XSL-FO)',contenu="text",prix_formation=1300;
insert into redline.formation set id=20,nom_formation='Les parseurs (Dom et Sax)',contenu="text",prix_formation=1200;
insert into redline.formation set id=21,nom_formation='Les fondamentaux de powerpoint',contenu="text",prix_formation=1500;
insert into redline.formation set id=22,nom_formation='Linux/Unix',contenu="text",prix_formation=3600;
insert into redline.formation set id=23,nom_formation='Introduction aux marchés boursiers',contenu="text",prix_formation=1300;
insert into redline.formation set id=24,nom_formation='Gérer les émotions et les conflits',contenu="text",prix_formation=1200;
insert into redline.formation set id=25,nom_formation='Introduction aux téléphonies sur IP',contenu="text",prix_formation=1300;
insert into redline.formation set id=26,nom_formation='Sécurité des réseaux privés',contenu="text",prix_formation=1200;
